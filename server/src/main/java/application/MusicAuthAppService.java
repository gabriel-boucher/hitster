...
public class MusicAuthAppService {
    private final RoomRepository roomRepository;
    private final SpotifyAuthRepository spotifyAuthRepository;
    private final ConnectionServer connectionServer;

    public MusicAuthAppService(RoomRepository roomRepository, SpotifyAuthRepository spotifyAuthRepository, ConnectionServer connectionServer) {
