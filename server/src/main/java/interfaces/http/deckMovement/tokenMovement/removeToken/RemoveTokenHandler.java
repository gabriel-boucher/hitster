...
public class RemoveTokenHandler implements RestEventHandlerWithRequest<RemoveTokenRequest> {
    ...
    @Override
    public EventResponse handleEvent(String gameId, String playerId, RemoveTokenRequest request) {
        try {
            RemoveTokenData data = removeTokenMapper.toDomain(gameId, playerId, request);
